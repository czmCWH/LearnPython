# 👉 1、Jupyter Notebook
# jupyter notebook 是一个基于 web 网页、交互式的编程笔记本，让你可以把代码、运行结果、图表和笔记全部都放在一个文件里。
# jupyter notebook 是在数据分析、机器学习、教学和科研等领域的数据实验室。
#
...
#    直接搜索 Microsoft 官方发布的 Jupyter 扩展，点击 Install（安装）。
#    新建 Jupyter Notebook 文件：
#      - VS Code 中右键点击文件夹，选择 New File -> Jupyter Notebook；
#      - 快捷键方式：按下 Cmd + Shift + P 调出命令面板，输入 Create: New Jupyter Notebook 并回车；
#      - 手动新建文件：在 VS Code 中新建一个空白文件，将其保存为以 .ipynb 结尾的文件；

# ⚠️，首次运行 Jupyter Notebook 时，会提示：运行具有"Python 3.13.10"的单元格需要ipykernel包。请安装它。
#
